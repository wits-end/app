<div class="wrapper">
	...
	<p>Wits End operates the https//witsend.ai website, which provides the SERVICE.</p>

	<p>
		This page is used to inform website visitors regarding our policies with the collection, use,
		and disclosure of Personal Information if anyone decided to use our Service, the Wits End
		website.
	</p>
	...
	<p>
		...
		which is accessible at https://witsend.ai, unless otherwise defined in this Privacy Policy.
	</p>
